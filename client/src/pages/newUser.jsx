    ...
    <div className="space-y-12">
      <div className="grid grid-cols-1 gap-x-8 gap-y-10 border-b border-gray-900/10 pb-12 md:grid-cols-3">
        ...
        <div className="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 md:col-span-2">
          ...
          <div className="col-span-full">
            ...
            <p className="mt-3 text-sm leading-6 text-gray-600">Escribe algunas frases sobre ti.</p>
          </div>
      ...
      <div className="grid grid-cols-1 gap-x-8 gap-y-10 border-b border-gray-900/10 pb-12 md:grid-cols-3">
        <div>
          ...
          <p className="mt-1 text-sm leading-6 text-gray-600">
            Siempre te informaremos sobre cambios importantes, pero tú decides qué más quieres recibir.
          </p>
        </div>

        <div className="max-w-2xl space-y-10 md:col-span-2">
          <fieldset>
            <legend className="text-sm font-semibold leading-6 text-gray-900">Por correo electrónico</legend>
            <div className="mt-6 space-y-6">
              <div className="relative flex gap-x-3">
                ...
                <div className="text-sm leading-6">
                  ...
                  <p className="text-gray-500">Recibe una notificación cuando alguien comenta en una publicación.</p>
                </div>
              </div>
              <div className="relative flex gap-x-3">
                <div className="flex h-6 items-center">
                ...
                <div className="text-sm leading-6">
                  ...
                  <p className="text-gray-500">Recibe una notificación cuando un candidato solicita un empleo.</p>
                </div>
              </div>
              <div className="relative flex gap-x-3">
                <div className="flex h-6 items-center">
                ...
                <div className="text-sm leading-6">
                  ...
                  <p className="text-gray-500">Recibe una notificación cuando un candidato acepta o rechaza una oferta.</p>
                </div>
              </div>
            </div>
          </fieldset>
          <fieldset>
            ...
            <p className="mt-1 text-sm leading-6 text-gray-600">Estas se envían mediante SMS a tu teléfono móvil.</p>
            <div className="mt-6 space-y-6">
