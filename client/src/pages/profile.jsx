  ...
  return (
    <div>
      <div className="px-4 sm:px-0">
        <h3 className="text-base font-semibold leading-7 text-gray-900">Información Profesional</h3>
      ...
      <div className="mt-6">
        <dl className="grid grid-cols-1 sm:grid-cols-2">
          ...
          <div className="border-t border-gray-100 px-4 py-6 sm:col-span-1 sm:px-0">
            ...
            <dd className="mt-1 text-sm leading-6 text-gray-700 sm:mt-2">Desarrollador Backend</dd>
          </div>
          <div className="border-t border-gray-100 px-4 py-6 sm:col-span-1 sm:px-0">
